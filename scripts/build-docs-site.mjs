    ...
    <main class="layout">
      ...
      <section class="grid">
        ...
        <article class="card">
          <h2>Contract</h2>
          <ul>
            <li>Core logic lives in web components.</li>
            <li>Brand identity lives in the external CSS token layer.</li>
            <li>React and Angular wrappers are published separately.</li>
            <li>Documentation is versioned with the released package.</li>
          </ul>
        </article>
      </section>
    </main>
